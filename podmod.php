...
<html lang="en">
    ...
    <div class="carousel-item active">
      <img src="img/2.gif" class="d-block w-70" width="100%" height="700" alt="...">
    </div>
  </div>
        ...
        <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    $tambah = mysqli_query($koneksi, "SELECT * from produk WHERE jenis='pod'");
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="detail1.php?id=<?= $produk['id'] ?>">DETAIL</a></div>
                            </div>
                            </div>
                        </div>
                    </div>
